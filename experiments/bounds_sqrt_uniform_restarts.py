...
if __name__ == "__main__":
    ...
    np.savez(os.path.join(root_path, "artifacts", "plot_store" + f"_bounds_sqrt_uniform_{n}_restarts_{norm_name}-norm"),
             **plot_store)
    ...
    fig.savefig(os.path.join(root_path, f"figures/bounds_sqrt_uniform_{n}_restarts_{norm_name}-norm.png"))
    plt.show()
    1 + 1
